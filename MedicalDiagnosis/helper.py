...
class Diagnosis:
    ...
    def __init__(self):
        ...
        # Lemmatize the data --> processus de regroupement 
    ...
    def predict(self,symptoms):
        ...
        predicted_disease = self.Y[self.knn.predict([test_symp])[0]]
        suggested_drug = self.data.loc[self.data["Disease"]==predicted_disease, 'Drug'].iloc[0]

        return [predicted_disease, suggested_drug]
